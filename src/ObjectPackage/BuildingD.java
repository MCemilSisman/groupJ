...
public class BuildingD extends Buildings {

	public BuildingD(int coordinateX, int coordinateY, Image image, BlockType[][] blockSize, int rotationType) throws FileNotFoundException {
