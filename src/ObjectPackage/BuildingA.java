...
public class BuildingA extends Buildings {

	public BuildingA(int coordinateX, int coordinateY, Image image, BlockType[][] blockSize, int rotationType) throws FileNotFoundException {
